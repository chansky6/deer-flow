...
export function MessageList({
  ...
  thread,
  messages,
  frameworkReviewInsertionMessageId,
  paddingBottom = 160,
  ...
  const frameworkReviewCard =
    frameworkReview?.status === "pending" &&
    !thread.isLoading &&
    onConfirmFrameworkReview ? (
      <FrameworkReviewCard
        key="framework-review-card"
        mode="pending"
  ...
  return (
    ...
    >
      <ConversationContent className="mx-auto w-full max-w-(--container-width-md) gap-8 pt-12">
        {renderMessageGroups(messagesBeforeFrameworkReview)}
        {frameworkReviewInsertionIndex >= 0 && frameworkReviewCard}
        {renderMessageGroups(messagesAfterFrameworkReview)}
        {frameworkReviewInsertionIndex < 0 && frameworkReviewCard}
