...
export const enUS: Translations = {
  ...
  common: {
    ...
    failedToDownload: "Failed to download artifact",
    failedToExport: "Failed to export artifact",
    thinking: "Thinking",
    artifacts: "Artifacts",
    public: "Public",
    custom: "Custom",
  ...
  admin: {
    ...
    configNote: "Changes to config.yaml take effect in the next new session",
    immediateNote: "Changes take effect immediately",
    save: "Save",
    saving: "Saving...",
    saveAll: "Save All",
    addModel: "Add Model",
    ...
    memory: {
      ...
      maxFacts: "Max Facts",
      confidenceThreshold: "Fact Confidence Threshold",
    ...
    summarization: {
      ...
      modelName: "Model Name",
      triggers: "Triggers",
      keepPolicy: "Keep Policy",
      trimTokens: "Trim Tokens to Summarize",
    },
    subagents: {
      title: "Subagents",
