...
export const zhCN: Translations = {
  ...
  admin: {
    ...
    configNote: "对 config.yaml 的修改将在下一个新会话中生效",
    immediateNote: "修改立即生效",
    save: "保存",
    saving: "保存中...",
    saveAll: "全部保存",
    addModel: "添加模型",
    ...
    memory: {
      ...
      modelName: "模型名称",
      maxFacts: "最大事实数",
      confidenceThreshold: "事实置信度阈值",
      injectionEnabled: "启用注入",
    ...
    summarization: {
      ...
      triggers: "触发条件",
      keepPolicy: "保留策略",
      trimTokens: "摘要裁剪 Token 数",
    },
    subagents: {
      title: "子代理",
      defaultTimeout: "默认超时（秒）",
      perAgentOverrides: "单代理覆盖",
    },
  },
};
