...
async def export_artifact(
    ...
    _auth: AuthContext = Depends(require_thread_owner),
) -> Response:
...
async def get_artifact(thread_id: str, path: str, request: Request, _auth: AuthContext = Depends(require_thread_owner)) -> FileResponse:
